# -*- coding: utf-8 -*-
"""Symbol discovery from TGJU global market page."""
...
class GlobalMarketDiscovery(BaseDiscovery):
    """Discover symbols from the TGJU global market indices page."""

    url = 'https://www.tgju.org/global-market'
